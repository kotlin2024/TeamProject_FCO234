...
//    }
     ...
     fun generateToken(subject: String,role:UserRole,birthday: String, expirationPeriod: Duration): String{

        val claims: Claims = Jwts.claims()
            .add(mapOf("role" to role,"birthday" to birthday)) // claims 안에 역할,생일, 고유id 값이 들어있음
            .build()
