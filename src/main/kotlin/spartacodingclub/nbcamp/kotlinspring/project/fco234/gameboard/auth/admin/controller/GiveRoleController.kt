package spartacodingclub.nbcamp.kotlinspring.project.fco234.gameboard.auth.admin.controller
...
@RestController
class GiveRoleController(private val giveRoleService: GiveRoleService) {

    @PutMapping("/admin")
    fun giveRole(@RequestBody giveRoleRequest: GiveRoleRequest) {
